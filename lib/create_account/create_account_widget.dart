                        ...
                        child: Container(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'yn44jpdo' /* Reseñas de Videojuegos */,
                            ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '0jkyy3h1' /* Reseñas de videjuegos pero pri... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                  ...
                                  Opacity(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'awp88vs4' /* Ingrese una contraseña con mas... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
